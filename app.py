...
# --- FUNCIONES MOTORAS (LÓGICA ESTADÍSTICA) ---
...
def realizar_test_proporciones(ct_abs):
    """Realiza test Z de proporciones entre pares de columnas (al 95%)."""
...
if archivo_cargado:
    ...
    st.sidebar.markdown("---")
    if st.sidebar.button("📊 GENERAR REPORTE (después de realizar todas las operaciones)"):
        output = io.BytesIO()
        ...
        st.sidebar.download_button("⬇️ DESCARGAR REPORTE", output.getvalue(), "Reporte_Papanajaco.xlsx")
